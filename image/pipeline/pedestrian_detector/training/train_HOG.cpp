...
int main( int argc, char** argv )
{
    cv::CommandLineParser parser(argc, argv,
        ...
        "{nd    |   | neg_dir}"
        "{n     |   | neg.lst}"
        "{md    |   | hard_neg_mining_dir}"
        "{m     |   | hard_neg_mining.lst}");
    ...
    string hard_neg_mining_dir = parser.get<string>("md");
    string hard_neg_mining = parser.get<string>("m");
    ...
    cout << "read pos images" << endl;
    load_images( pos_dir, pos, pos_lst );
    labels.assign( pos_lst.size(), +1 );
    const unsigned int old = (unsigned int)labels.size();
    cout << pos_lst.size() << " images have been read as pos image" << endl;
    cout << "read neg images" << endl;
    ...
    cout << full_neg_lst.size() << " images have been read as neg image" << endl;
    
    cout << "compute hog for positives" << endl;
    compute_hog( pos_lst, gradient_lst, Size( 96, 160 ) );
    cout << "compute hog for negatives" << endl;
    compute_hog( full_neg_lst, gradient_lst, Size( 96, 160 ) );
